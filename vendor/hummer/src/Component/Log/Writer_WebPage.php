...
<style type="text/css" media="screen">
    ...
    #Template_Log .TPT_Msg{ width: 600px; background-color: #ECECEC; clear: right; float: right; padding-bottom: 10px;  font-family: 微软雅黑,幼圆; font-size: 14px; display: none; border: 1px solid #ccc; border-top: 0; box-shadow: 10px 10px 20px #ccc; border-bottom-left-radius: 10px; }
